...
<body>
    ...
    <table class="table table-bordered mx-auto" style="width: 84.5%; margin-top: 10px; border-color: gray; border-radius: 10px; overflow: hidden;">
        <thead>
            <tr style="background-color: #3D9EDE; color: white;">
                <td scope="col" style="width: 35%; text-align: center;">NIP/NIK</td>
                <td scope="col" style="width: 35%; text-align: center;">Nama Dosen</td>
                <td scope="col" style="width: 30%; text-align: center;">Aksi</td>
            </tr>
        </thead>
        <tbody>
            ...
            <tr style="height: 80px" class="dosen-row">
                ...
                <td style="text-align: center; vertical-align: middle; align-items: center;">
                    <a href="{{ route('ubah-dosen', ['iddosen' => $dosenItem->iddosen]) }}" class="btn btn-warning" style="margin-right: 35px;">Ubah</a>
                    <button type="button" class="btn btn-danger delete-btn" data-id="{{ $dosenItem->iddosen }}" >Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <a href="/tambah-dosen">
                    <button type="button" class="btn btn-primary" style="font-size: 12px;">Tambah Dosen</button>
                </a>
            </div>
