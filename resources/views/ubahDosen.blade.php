...
<body>
    ...
    <div class="container">
        <div class="UbahDosen" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; word-wrap: break-word; padding-top: 50px">
            Ubah Dosen</div>
    </div>

    <div class="container">
        @foreach($dosenItems as $dosenItem)
        <form method="POST" action="{{ route('ubah-dosen', ['iddosen' => $dosenItem->iddosen]) }}">
            @csrf
            @method('PATCH')
            <label for="nipk" style="color: black; font-size: 20px; font-family: Roboto; font-weight: 400; padding-top: 10px;">NIP/NIK</label>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" id="nipk" name="nipk" placeholder="Masukkan NIP/NIK" autocomplete="off" value="{{ $dosenItem->nipk }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" placeholder="Masukkan Nama Dosen" autocomplete="off" value="{{ $dosenItem->nama_dosen }}">
                </div>
            </div>
