    ...
    <table class="table table-bordered mx-auto" style="width: 84.5%; margin-top: 10px; border-color: gray; border-radius: 10px; overflow: hidden;">
        <thead>
            <tr style="background-color: #3D9EDE; color: white;">
                <td scope="col" style="width: 20%; text-align: center;">Kode Mata Kuliah</td>
                <td scope="col" style="width: 40%; text-align: center;">Mata Kuliah</td>
                <td scope="col" style="width: 10%; text-align: center;">SKS</td>
                <td scope="col" style="width: 20%; text-align: center;">Aksi</td>
            </tr>
        </thead>
        <tbody>
            ...
            <tr style="height: 80px" class="matkul-row">
                ...
                <td style="text-align: center; vertical-align: middle; align-items: center;">
                    <a href="{{ route('ubah-matkul', ['idmatkul' => $matkulItem->idmatkul]) }}" class="btn btn-warning" style="margin-right: 35px;">Ubah</a>
                    <button type="button" class="btn btn-danger delete-btn" data-id="{{ $matkulItem->idmatkul }}">Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <a href="/tambah-matkul">
                    <button type="button" class="btn btn-primary" style="font-size: 12px;">Tambah Matkul</button>
                </a>
            </div>
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', () => {
                const idmatkul = button.getAttribute('data-id'); // Menggunakan idmatkul yang benar

                // Konfirmasi penghapusan
                if (confirm('Apakah Anda yakin ingin menghapus matkul ini?')) {
                    // Kirim permintaan penghapusan ke server dengan ID mata kuliah yang sesuai
