    ...
    <table class="table table-bordered mx-auto" style="width: 84.5%; margin-top: 10px; border-color: gray; border-radius: 10px; overflow: hidden;">
        <thead>
            <tr style="background-color: #3D9EDE; color: white;">
                <td scope="col" style="width: 10%; text-align: center;">Kode Ruangan</td>
                <td scope="col" style="width: 10%; text-align: center;">Nama Ruangan</td>
                <td scope="col" style="width: 10%; text-align: center;">Luas Ruangan</td>
                <td scope="col" style="width: 10%; text-align: center;">Status Ruangan</td>
        ...
        <tbody>
            ...
            <tr style="height: 80px" class="ruangan-row">
                ...
                <td style="text-align: center; vertical-align: middle; align-items: center;">
                    <a href="{{ route('ubah-ruangan', ['idruangan' => $ruanganItem->idruangan]) }}" class="btn btn-warning" style="margin-right: 35px;">Ubah</a>
                    <button type="button" class="btn btn-danger delete-btn" data-id="{{ $ruanganItem->idruangan }}">Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <a href="/tambah-ruangan">
                    <button type="button" class="btn btn-primary" style="font-size: 12px;">Tambah Ruangan</button>
                </a>
            </div>
