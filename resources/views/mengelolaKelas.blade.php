...
<body>
    ...
    <table class="table table-bordered mx-auto" style="width: 84.5%; margin-top: 10px; border-color: gray; border-radius: 10px; overflow: hidden;">
        <thead>
            <tr style="background-color: #3D9EDE; color: white;">
                <td scope="col" style="width: 50%; text-align: center;">Kelas</td>
        ...
        <tbody>
            ...
            <tr style="height: 80px" class="kelas-row">
                ...
                <td style="text-align: center; vertical-align: middle; align-items: center;">
                    <a href="{{ route('ubah-kelas', ['idkelas' => $kelasItem->idkelas]) }}" class="btn btn-warning" style="margin-right: 35px;">Ubah</a>
                    <button type="button" class="btn btn-danger delete-btn" data-id="{{ $kelasItem->idkelas }}" >Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <a href="/tambah-kelas">
                    <button type="button" class="btn btn-primary" style="font-size: 12px;">Tambah Kelas</button>
                </a>
            </div>
